...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hostListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                intent = new Intent(MainActivity.this, ViewHost.class);
                intent.putExtra("_id", id);
                startActivity(intent);
            }
        });

        toolbar.setSubtitle("Total Hosts: " + dbHandler.getTotalHosts());
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.susie.invite/http/host/path")
        );
